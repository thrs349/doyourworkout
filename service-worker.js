...
const CACHE_NAME = "doyourworkout-v2.4.3"; // v2.4.3: 이번 릴리즈(알림센터 UI 개선, 팝업 줄바꿈/체크리스트,
// 미설정 중량 아이콘, 홈 화면 루틴 미등록 흐름 개선)를 새 캐시로 확실히 반영하기 위해 버전을 올립니다.
// 신규 JS 파일 추가는 없어(기존 파일 diff와 대조해 재확인) CORE_ASSETS 목록 자체는 변경하지 않았습니다.
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
