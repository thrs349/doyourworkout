...
const CACHE_NAME = "doyourworkout-v2.4.6"; // v2.4.6: 이번 릴리즈(타이틀 viewport 중앙정렬 전역화, 루틴화면
// 버튼 우측정렬 복구, 운동화면 큐노트 하이라이트 제거)를 새 캐시로 확실히 반영하기 위해 버전을 올립니다.
// 신규 JS 파일 추가는 없어(기존 파일 diff와 대조해 재확인) CORE_ASSETS 목록은 변경하지 않았습니다.
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
