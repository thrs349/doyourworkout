...
const CACHE_NAME = "doyourworkout-v2.4.5"; // v2.4.5: 이번 릴리즈(도전세트 후보 가로배치, 루틴화면 버튼통일+
// 타이틀 중앙정렬, 고반복 팝업 문구, 미설정 중량 아이콘, 큐노트/운동화면 아이콘 통일, 죽은 CSS 정리)를 새
// 캐시로 확실히 반영하기 위해 버전을 올립니다. 신규 JS 파일 추가는 없어 CORE_ASSETS 목록은 변경하지 않았습니다.
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
